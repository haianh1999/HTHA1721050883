...
using HTHA1721050883.Models;

namespace HTHA1721050883.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            {
                var PesonID = db.Persons.OrderByDescending(m => m.perSonID).FirstOrDefault().perSonID;
                var newID = auto.GenKey("PER", (string)PesonID);
                ViewBag.newid = newID;
            }
